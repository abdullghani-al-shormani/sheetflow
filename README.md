...
**SheetFlow** is a lightweight, fluid, and highly customizable Android BottomSheet library built using the Fluent Builder pattern. It simplifies creating complex BottomSheet dialogs—ranging from dynamic lists and action menus to custom layouts, alert confirmations, and persistent peek-height sheets—with minimal boilerplate code.
